...
const QuickLink: React.FC<TShortcut> = ({
  ...
  return (
    <Link to={route}>
      <article
        className={`${className} rounded-lg mx-auto md:w-[170px] h-fit p-4 text-center text-white hover:scale-90 transition-all ease-in-out duration-500 hover:bg-opacity-85`}
      >
