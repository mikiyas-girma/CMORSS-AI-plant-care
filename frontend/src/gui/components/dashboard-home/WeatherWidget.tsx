...
const WeatherWidget = () => {
  ...
  //   Return JSX
  return (
    <div className="relative flex flex-col items-center justify-center gap-1 overflow-hidden rounded-xl bg-primary-green bg-[url(/cloud_bg.png)] bg-cover object-cover sm:p-3 py-4 text-white w-full lg:w-auto">
      {loading && (
        <LoadingComp
